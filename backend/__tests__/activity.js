...
describe('Activity', () => {
    describe('convertToUserActivity', () => {
        it('should return it in the correct format', async () => {
          ...
          const expectedOutput = {
            ...
            let actual = Activity.convertToUserActivity(Activity.LIKED, postId, updatedAt);
    ...
    describe('convertToFeedActivity', () => {
        it('should return it in the correct format', async () => {
            ...
            const actual = await Activity.convertToFeedActivity(Activity.LIKED, newPost.id, user1.id, newPost.createdAt);
            expect(actual).toEqual(expectedOutput)
        })
    })
});